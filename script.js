...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Assicurati che, all'inizio, container2 e container3 siano disabilitati
  ...
  // se non è spuntata, disabilita il secondo (e di conseguenza anche il terzo)
  checkbox1.addEventListener("change", function() {
    if (this.checked) {
      ...
      container2.classList.add("disabled");
      // Disabilita anche il terzo se il secondo non è abilitato
      container3.classList.remove("enabled");
      container3.classList.add("disabled");
      // Deseleziona la checkbox del secondo carosello
